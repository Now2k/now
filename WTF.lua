...
local Window = Fluent:CreateWindow({
    Title = "Xuan Anh",
    SubTitle = "https://discord.gg/M2VGYqyn",
    TabWidth = 160,
...
ImageButton.Image = "rbxassetid://id ?nh"
...
CamShake:Stop()
    ...
    local ToggleBringMob = Tabs.Setting:AddToggle("ToggleBringMob", {Title = "Katakuri", Default = false })
